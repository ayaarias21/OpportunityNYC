  ...
  return (
    <div>
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(180deg, rgba(15,22,18,0.6) 0%, rgba(15,22,18,0.75) 100%), url(${nycTrainSkyline})`,
          backgroundPosition: "center 40%",
        }}
      >
        <div className="max-w-md mx-auto bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl px-8 py-9">
          <h1 className="font-sans font-semibold text-2xl mb-1.5">Welcome back</h1>
          <p className="text-warm-gray text-sm mb-8">
            Sign in to continue to your OpportunityNYC account.
          </p>
